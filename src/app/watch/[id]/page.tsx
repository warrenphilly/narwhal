  ...
  return (
    <div className="flex min-h-full flex-col bg-[#f5f5f7]">
      <div className="flex items-center gap-3 px-4 py-4">
        ...
        <p className="text-sm text-zinc-600">{item?.Name ?? "Playing"}</p>
      </div>
      <div className="flex flex-1 items-center justify-center px-4 pb-10">
        {demo ? (
          <div className="max-w-lg rounded-3xl border border-zinc-200 bg-white p-10 text-center">
            <p className="text-2xl font-semibold text-zinc-900">Playback needs your server</p>
